...
class Navwalker extends Walker_Nav_Menu {
    ...
    public function start_lvl(&$output, $depth = 0, $args = array()) {
        ...
        $output .= "<div class='navbar-item has-text-dark is-flex-direction-column is-align-items-flex-start'>";
    }
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        if ($hasChildren) {
            ...
            $output .= "\n<a class='navbar-link navbar-item has-text-dark' href='" . $item->url . "'>" . $item->title . "</a>";
